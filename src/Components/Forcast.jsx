...
const Forcast = () => {
    ...
    const searchcity = (city) => {
        fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city != "" ? city : location}&units=imperial&appid=319de7333d6f77f7ea98d69dbc188698`)
            .then(res => res.json())
            .then(data => {
                setData(data);
                setLocation("");
        ...
        <div className='wrapper'>
            <div className="forcast">
                ...
                <div className="today-weather">
                    <h3>{data.main ? data.weather[0].main : "Weather App"}</h3>
            ...
            <div className="section">
                <CurrTime location={location} data={data} />
            </div>
        </div>
    )
}
